...
/**
 * @file
 * Shared functions for the hcgProducts plugin
 *
 */
 ...
 * @return	string
 */	
function _hcgproducts_entities_to_ascii($str, $all = TRUE)
{
 ...
 * @return	string
 */	
function hcgproducts_get_control($type, $label, $id, $name, $value = '',  $data = null, $info = '', $style = 'input widefat')
{
   $output = '<p>';
   switch($type) {
      case 'hidden':
